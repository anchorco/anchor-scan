...
from agentscan.models import AnalysisReport, Status, Severity, CheckResult
...
def print_report(report: AnalysisReport):
    ...
    header = Text()
    header.append("AGENTSCAN - CODE PATTERN ANALYSIS\n", style="bold white")
...
def generate_markdown(report: AnalysisReport) -> str:
    ...
    lines = [
        "# AgentScan - Code Pattern Analysis Report",
        "",
...
<head>
    ...
    <title>AgentScan - Code Pattern Analysis</title>
    <style>
        :root {{
            --bg-primary: #ffffff;
            --bg-secondary: #f8fafc;
    ...
    <div class="container">
        <header class="header">
            <div class="header-content">
                <h1>AgentScan - Code Pattern Analysis</h1>
